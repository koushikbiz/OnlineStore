...
public class DriverScript {
  ...
  public static void create_Object() throws NoSuchMethodException, SecurityException{
  ...
  public static void main(String[] args) throws Exception {
	  ...
	  // Here we are passing the Excel path and SheetName as arguments to connect with Excel file 
  	  ...
  	  System.setProperty("log4j.configurationFile", "file:///C:/Users/Me/eclipse-workspace/OnlineStore/log4j2.xml");
	  ...
	  //This will return the total number of test cases mentioned in the Test cases sheet
		...
		for(int iTestcase=1;iTestcase<=iTotalTestCases;iTestcase++){
			...
			if (sRunMode.equals("Yes")){
				...
				//System.out.println("First Test Step" +iTestStep);
				//System.out.println("Last Test Step" +iTestLastStep);
